              ...
              <>
                ...
                <div className={data_grid}>
                  <div className='a'>
                    ...
                    <object data={PDFs[reportPDF]} type="application/pdf" frameborder="0" width="100%" height="600px" style={{ marginLeft: 'auto', marginRight: 'auto', width: '100%' }} aria-label = 'PDF Viewer'>
