...
function Citation(){
  ...
  '(Bloom, Palmer, & Winninghoff, '+current_year+'). <b><a href = "http://www.nationaldeafcenter.org/dashboard" style = "text-decoration: none; color: #0000EE">www.nationaldeafcenter.org/dashboard</a></b>'])
}
